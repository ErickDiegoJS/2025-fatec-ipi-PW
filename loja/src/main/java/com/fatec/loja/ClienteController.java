...
public class ClienteController {
    ...
    //a função retorno um cliente
    public Cliente fazerLogin(@RequestBody Cliente obj){
        //o tipo optional é utilizado para retornar o cliente ou null e atribuir esse valor na variavel retorno
        Optional<Cliente> retorno = bd.fazerLogin(obj.getEmail(), obj.getSenha());
        //caso esteja presente, retorna o cliente
        //caso contrario, retorna um novo cliente vazio
